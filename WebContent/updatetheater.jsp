...
<body>
    ...
    <div class="container" style="margin: 10px;">
      <div class="row" align="center"><h2>UPDATE THEATER:-${param.msg}</h2>
  </div>
  <div>
  &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp;
  </div>
  ...
  <div class="form-group">
			<label class="control-label col-sm-2" for="theaterid">Theater Id</label>
				<div class="col-md-5">
					<input type="text" class="form-control" name="theaterid" value="<%=request.getParameter("id") %>" readonly placeholder="Enter Theater Id">
				</div>
			</div>
  <div class="form-group">
			<label class="control-label col-sm-2" for="theater name">Theater Name</label>
				<div class="col-md-5">
					<input type="text" class="form-control" name="theatername" value=<%=request.getParameter("name") %>  placeholder="Enter Theater Name">
				</div>
			</div>
			<div class="form-group">
      ...
      <div class="col-md-5">
		...
		<div class="form-group">
			...
			<div class="col-md-5"> 
		        <textarea rows="3" cols="50" name="address" placeholder="Address"><%=request.getParameter("add") %></textarea>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-5"> 
				<input type="text" class="form-control" name="pincode" value=<%=request.getParameter("pin") %> placeholder="Enter pincode">
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-sm-2" for="screen">No of Screens</label>
			<div class="col-md-5"> 
				<input type="text" class="form-control" name="screen" value=<%=request.getParameter("screen") %> placeholder="Enter No of Screens">
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-sm-2" for="screen">No of Seats</label>
			<div class="col-md-5"> 

		...
		<div class="header-top-strip" id="home">
			<div class="container">
				<div class="header-top-left">
					<p><a href="#"><h4>WELCOME ADMIN:-<%=admin%></h4></a> | <a class="play-icon popup-with-zoom-anim" href="#small-dialog" href="#"> Resend Booking Confirmation</a> </p>
	...
	<div class="bootstrap_container">
            ...
            <div id="defaultmenu" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
					...
					<li class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Theater<b class="caret"></b></a>
                     <ul class="dropdown-menu" role="menu">
                    
                                
								
								  <li><a href="addtheater.jsp" target="ifra">Add Theater</a></li>
	                               
	                               <li><a href="viewtheater.jsp" target="ifra">View Theater</a></li>
								</ul>
					</li>
				...
				<li class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Show<b class="caret"></b></a>
                     <ul class="dropdown-menu" role="menu">
								  ...
								  <li><a href="addshow.jsp" target="ifra">Add Shows</a></li>
	                               <li><a href="viewshow.jsp" target="ifra">View Shows</a></li>
...
<div>
	...
	<div class="main-banner">
		<iframe   height="1000px" width="100%" frameborder="0" name="ifra" style="background-image:url(images/g.jpg)" ></iframe>

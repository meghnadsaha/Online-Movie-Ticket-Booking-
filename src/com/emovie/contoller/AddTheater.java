...
public class AddTheater extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int status=TheaterDao.save(t);
		if(status>0)
		{
			response.sendRedirect("addtheater.jsp?msg=Theater added");
		}
		else
		{
			response.sendRedirect("addtheater.jsp?msg=you already added this theater");
		}
	}
